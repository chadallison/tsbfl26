...
google_sheet_url = "https://docs.google.com/spreadsheets/d/1-yhwCwkph7TanT4R0oTC4d6Y2NwKbZ-m-ysbkxQx9hs/edit?usp=sharing"
parlays = read_sheet(google_sheet_url, sheet = 1)

team_divisions = tibble(
  name = c("Andrew", "Eric", "Adam", "Isaac", "David",
           "Hank", "JP", "Josh", "Chad", "Matthew"),
...
```{r echo = F}
drinker = c("Drew", "Hank", "Adam", "Josh")
time = c(8.6, 13.2, 13.0, 30.6)
...
tibble(drinker, time) |>
  ...
  labs(x = NULL,
       y = "Chug time (seconds)",
       title = "The rest of you are cowards")
```
...
parlays |>
  ...
  labs(x = NULL, y = "Parlay leg win percentage",
       title = "NO MORE BETTING ON BARES DOLPHINS ON PANTHERS")
```
